...
public class AchievementEntityMapperImpl implements AchievementEntityMapper {
    ...
    public Achievement mapFromEntity(AchievementEntity entity) {
        ...
        achievement.tournament( tournamentEntityToTournament( entity.getTournament() ) );
    ...
    protected List<Achievement> achievementEntitySetToAchievementList(Set<AchievementEntity> set) {
        ...
        for ( AchievementEntity achievementEntity : set ) {
            list.add( mapFromEntity( achievementEntity ) );
        }
    ...
    protected Set<AchievementEntity> achievementListToAchievementEntitySet(List<Achievement> list) {
        ...
        for ( Achievement achievement : list ) {
            set.add( mapToEntity( achievement ) );
        }
